 ...
 */
public final class CustomControllerIndex {
     ...
     */
    CustomControllerIndex(int index) {
        this.index = index;
    ...
    */
    ...
    public boolean doVibration(float leftMagnitude, float rightMagnitude, int duration_ms) throws ControllerUnpluggedException {
        ...
        return nativeDoVibration(this.controllerPtr, (int) (65535 * leftMagnitude), (int) (65535 * rightMagnitude), duration_ms);
    }
    ...
    private void updateButton(int buttonIndex) throws ControllerUnpluggedException {
        ...
        boolean currButtonIsPressed = nativeCheckButton(this.controllerPtr, buttonIndex);
    ...
    */
    ...
    public float getAxisState(ControllerAxis toCheck) throws ControllerUnpluggedException {
        ...
        if (toCheck == ControllerAxis.LEFTY || toCheck == ControllerAxis.RIGHTY) {
            toReturn = nativeCheckAxis(this.controllerPtr, toCheck.ordinal()) / -AXIS_MAX_VAL;
        } else {
            toReturn = nativeCheckAxis(this.controllerPtr, toCheck.ordinal()) / AXIS_MAX_VAL;
        }
    ...
    */
    ...
    public String getName() throws ControllerUnpluggedException {
        ensureConnected();
        String controllerName = nativeGetName(this.controllerPtr);
